...
2. **プラン立案**: target_keyword / title(キーワード前方配置・32字前後)/ meta_description(100〜120字)/ outline。monetization は `"adsense"`、price_yen は 0。monetization_reason にキーワード選定理由(検索需要・競合の弱さ・CPC水準)を書く
